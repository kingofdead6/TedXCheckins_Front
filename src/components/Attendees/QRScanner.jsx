        ...
        <div className="bg-[#e62b1e] p-4 text-white">
          <div className="flex justify-between items-center">
            ...
            <Link
              ...
              className="cursor-pointer flex items-center bg-white text-[#e62b1e] px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition-colors"
            >
              ...
              >
                <div className="flex items-start mb-4">
                  <div className={`p-2 rounded-full ${
                    scanResult.valid ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'
                  }`}>
                    {scanResult.valid ? (
                ...
                {scanResult.valid && scanResult.attendee && (
                  <div className="mt-4 space-y-2">
                    <div className="border-t border-gray-200 pt-4">
                      <h4 className="text-sm font-medium text-gray-500 mb-2">ATTENDEE DETAILS</h4>
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-4">
                      ...
                      <div>
                        <p className="text-xs font-medium text-gray-500">Validation Time</p>
                        <p className="text-sm">
                          {scanResult.attendee.validationTime
                            ? new Date(scanResult.attendee.validationTime).toLocaleTimeString()
                            : 'N/A'}
                        </p>
                      </div>
                    </div>
                ...
                <div className="mt-6 flex justify-end">
                  <motion.button
                    onClick={closePopup}
                    className="cursor-pointer px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition-colors"
